...
public class Objective9Lab5 {
  ...
  public static void main(String[] args) {
    ...
    System.out.print("Now give me another number, please: ");
    num2 = kb.nextDouble();
      ...
      case 2:
        ...
        System.out.print("The average of " + num1 + " and " + num2 + " is: " + avg);
        break;
      case 3:
        double tax = calcTax(num1, num2);
        System.out.print("The tax on a purchase of " + num1 + " and " + num2 + " is: " + tax);
        break;
      case 4:
